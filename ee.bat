...
@echo off
chcp 65001
title Warning SPOOFER (Leaked By Strexer)
cls
mode 80,15
echo.
echo.
echo    BASE LOADING... [Fake Spoofer Apla phran to black kai to ekanan warning xD]
timeout 3 >nul
echo.
echo.
echo [32m[] Eukolo leak[0m
echo.
echo [32m[] Ez Money[0m
timeout 2 >nul
echo.
echo [31m[] TOYS GAMHSA ![0m
timeout 3 >nul
echo.
echo [32m[] Strexer The Cracker[0m
timeout 2 >nul
goto MENU
...
echo   	[32m╚═╝  ╚═╝╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝ ╚═════╝     ╚══════╝╚═╝      ╚═════╝  ╚═════╝ ╚═╝     ╚══════╝╚═╝  ╚═╝
echo.
echo						  [32mMADE BY RASKO AND AK47 
echo.
echo.
echo.
echo.
...
echo						  [32mMADE BY RASKO AND AK47 
echo.
echo                                   	 	[32m[1][32mSpoof Fivem                      
echo                                   	 	[32m[2][32mClean chace
echo                                   	 	[32m[3][32mClean logs                    
echo.
echo.
echo.
set /p key=Enter Your Number: 
